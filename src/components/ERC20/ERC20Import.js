...
const ERC20Import = ({ tokenAddress }) => {
  ...
  const [tokenData, setTokenData] = useState([
    ...
    { id: 1, name: "Name", value: "Loading..." },
    { id: 2, name: "Symbol", value: "Loading..." },
    { id: 3, name: "TotalSupply", value: "Loading..." },
    { id: 4, name: "Decimals", value: "Loading..." },
    { id: 5, name: "Current balance", value: "Loading..." },
  ]);
